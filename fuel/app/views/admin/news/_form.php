	...
	<fieldset>
		...
		<div class="form-group">
			<?php echo Form::label('Category', 'category', array('class'=>'control-label')); ?>
				...
				<!-- <?php echo Form::input('category', Input::post('category', isset($news) ? $news->category : ''), array('class' => 'col-md-4 form-control', 'placeholder'=>'Category')); ?> -->
		...
		<div class="form-group">
			<?php echo Form::label('Body', 'body', array('class'=>'control-label')); ?>
				...
				<?php echo Form::textarea('body', Input::post('body', isset($news) ? $news->body : ''), array('class' => 'col-md-8 form-control', 'rows' => 8, 'placeholder'=>'Body')); ?>
